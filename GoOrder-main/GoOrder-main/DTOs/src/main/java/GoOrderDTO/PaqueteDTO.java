...
public class PaqueteDTO {
    ...
    public PaqueteDTO(String idPaquete, ImagenDTO imagen, String nombre, Double precio, LocalDate fechaInicioVigencia, LocalDate fechaFinVigencia, List<ItemPaqueteDTO> listaProductos) {
