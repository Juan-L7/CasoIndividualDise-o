...
public class RegistroProducto extends JFrame{
    ...
    private JComboBox<ItemCategoria> cmbCategoria;
    ...
    private void inicializarComponentes() {
        ...
        setBackground(COLOR_FONDO_VERDE);
        setLayout(null); 

        Font fuenteTitulos = new Font("Arial", Font.BOLD, 36);
        Font fuenteEtiquetas = new Font("Arial", Font.BOLD, 18);
        ...
        txtNombre.setBounds(130, 90, 200, 25);
        ...
        btnBuscarImagen.setFont(new Font("Arial", Font.BOLD, 12));
        btnBuscarImagen.setBounds(240, 290, 90, 30);
        ...
        lblCategoria.setBounds(30, 410, 100, 25);
        add(lblCategoria);

        cmbCategoria = new JComboBox<>();
        cmbCategoria.setBounds(130, 410, 150, 25);
        ...
        btnRegistrar.setBounds(230, 540, 100, 35);
    ...
    if (productoExistente.getImagen() != null) {
        ...
        try {
            ...
            System.out.println("No se pudo cargar la preview de la imagen vieja");
        }
    }
}
    ...
    class ItemCategoria {
        ...
        public ItemCategoria(String id, String nombre) {
            this.id = id;
            this.nombre = nombre;
        }
